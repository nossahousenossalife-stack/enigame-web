      ...
      <div className="flex-1 flex flex-col items-center justify-start overflow-y-auto pt-20">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-2 w-full max-w-sm">
          ...
          <div className="flex gap-2 w-full">
            <button
              type="submit"
              className="flex-1 arcade-border py-3 px-2 bg-gray-900 text-lime-400 font-bold text-xs transition-all hover:shadow-lg hover:shadow-lime-400 arcade-neon-green flex items-center justify-center"
            ...
            <button
              ...
              className="flex-1 arcade-border py-3 px-2 bg-gray-900 text-fuchsia-500 font-mono text-xs transition-all hover:shadow-lg hover:shadow-fuchsia-500 arcade-neon-magenta flex items-center justify-center"
            >
        ...
        {alternativeHintMessage && (
          <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 pt-40" onClick={handleModalClick}>
            <div className="arcade-border bg-gray-900 text-center max-w-sm w-11/12 relative">
              <button
                onClick={() => setAlternativeHintMessage(null)}
                className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-2 flex items-center justify-end pr-2 arcade-border text-xs"
              >
                X
              </button>
              <p className="arcade-neon-cyan text-sm md:text-base p-4">
                💬 {alternativeHintMessage}
              </p>
            </div>
          </div>
